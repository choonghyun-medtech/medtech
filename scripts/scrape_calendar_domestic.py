...
# [2026-09-17] 스카이랩스의 증권신고서 제출이 캘린더에 안 잡힌다는 사용자 리포트로
# "증권신고서"/"투자설명서"가 화이트리스트에 없던 걸 발견해 추가. "[기재정정]증권신고서
# (지분증권)"처럼 접두사가 붙어도 부분일치(search)라 그대로 잡힌다.
CATEGORY_RULES = [
    ...
    (re.compile(r"증권신고서|투자설명서"), "listing", "증권신고서/투자설명서 제출(공모·증자)"),
